...
const oneHour = 3600000; // One hour in seconds
...
// The request will be redirected to Onshape for authentication, so callback is unused
app.use('/oauthSignin', storeExtraParams, (req, res) => { });
...
//   signin page.  Otherwise, the primary route function will be called,
