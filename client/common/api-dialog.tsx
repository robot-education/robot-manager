...
function isExecuting(menuState: MenuState): boolean {
    return menuState === MenuState.EXECUTING;
}
    ...
    const footer = (
        <DialogFooter
            ...
            actions={
                (isDone(menuState)) && (
                    <>
                        {menuState === MenuState.SUCCESS && props.successActions}
                        <Button
                            text="Close"
                            intent={menuState === MenuState.SUCCESS ? Intent.SUCCESS : Intent.PRIMARY}
                            icon="tick"
                            onClick={closeMenu}
                        />
                    </>
